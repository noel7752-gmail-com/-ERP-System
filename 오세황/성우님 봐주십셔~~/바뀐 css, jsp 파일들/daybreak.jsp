...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/resources/css/desktop.css" type="text/css" />
  ...
  <body>
    <%@include file="./partials/header.jsp"%> <%@include file="./partials/homeContent.jsp"%>
    <div class="bigScreen">
      <span>화면 크기가 너무 작습니다!</span>
    </div>
  </body>
</html>
